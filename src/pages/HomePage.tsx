        ...
        {selectedFlyoutGroup && (
          <div
            ...
            style={{
              ...
              left: 0,
              right: 0,
              background: isDark ? 'rgba(7, 22, 13, 0.88)' : 'rgba(255, 255, 255, 0.9)',
              backdropFilter: 'blur(24px) saturate(140%)',
              WebkitBackdropFilter: 'blur(24px) saturate(140%)',
              borderTop: isDark ? '1px solid rgba(102, 187, 42, 0.28)' : '1px solid rgba(18, 43, 26, 0.08)',
              borderBottom: isDark ? '1px solid rgba(102, 187, 42, 0.28)' : '1px solid rgba(18, 43, 26, 0.12)',
              boxShadow: isDark ? '0 24px 60px rgba(0, 0, 0, 0.7), 0 0 30px rgba(102, 187, 42, 0.1)' : '0 20px 40px -10px rgba(18, 43, 26, 0.14)',
              zIndex: 100,
              animation: 'rfGlassyFlyoutAppear 0.22s cubic-bezier(0.16, 1, 0.3, 1)',
